...
parser.add_argument('--feat_type', type=str, default='wav2vec2', help='Type of features: fbank, wav2vec2')
parser.add_argument('--feat_dim', type=int, default=768, help='Dim of features: fbank(80), wav2vec2(768)')
