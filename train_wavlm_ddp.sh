...
# python3 trainECAPAModelDDP.py --save_path exps/exp_wavlm_base_plus_sv_ddp --feat_type wavlm --n_cpu 10 --batch_size 128 --model_name microsoft/wavlm-base-plus-sv
...
# python3 trainECAPAModelDDP.py --save_path exps/exp_wavlm_base_sv_ddp --feat_type wavlm --n_cpu 10 --batch_size 128 --model_name microsoft/wavlm-base-sv
