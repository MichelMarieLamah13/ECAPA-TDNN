...
from DENSENETModel_orig import DENSENETModel
from tools import *
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DENSENET_trainer")
    # Training Settings
    parser.add_argument('--config',
                        type=str,
                        default="config_densenet.yml",
